...
public class PatrolManager : AIManager
{
    ...
    //public bool ProximityCheck(Patrol patrol)
    //{
    ...
    //        if ((p.transform.position - patrol.transform.position).sqrMagnitude < patrol.AwarenessDistance * patrol.AwarenessDistance)
    //            return true;
    //    }
