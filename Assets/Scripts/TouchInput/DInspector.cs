...
{
    public class DInspector<T> : Editor
        where T : Object
    {
        protected T tgt;
        protected T[] tgts;
        ...
        public static void BeginError(bool error)
        {
            ...
            EditorGUI.DrawRect(rect, error ? Color.red : Color.clear);
        }
        ...
        public static void DrawExpand(ref bool expand, Rect rect)
        {
            ...
            if(EditorGUI.DropdownButton(new Rect(rect.position + Vector2.left * 15, new Vector2(15.0f, rect.height)),
                                        new GUIContent(expand ? "-" : "+"), FocusType.Keyboard, expandStyle))
            {
                expand = !expand;
            }
        }
        ...
        protected bool DrawExpand(ref bool expand, string propertyPath, string overrideTooltip = null, string overrideText = null)
        {
            ...
            customContent.text = !string.IsNullOrEmpty(overrideText) ? overrideText : property.displayName;
            customContent.tooltip = !string.IsNullOrEmpty(overrideTooltip) ? overrideTooltip : property.tooltip;
